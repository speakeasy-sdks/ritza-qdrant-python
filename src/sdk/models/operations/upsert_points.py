...
class UpsertPoints200ApplicationJSONStatusEnum(str, Enum):
    OK = 'ok'
...
class UpsertPoints200ApplicationJSON:
    ...
    status: Optional[UpsertPoints200ApplicationJSONStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
