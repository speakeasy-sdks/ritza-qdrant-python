...
class SetPayload200ApplicationJSONStatusEnum(str, Enum):
    OK = 'ok'
...
class SetPayload200ApplicationJSON:
    ...
    status: Optional[SetPayload200ApplicationJSONStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
